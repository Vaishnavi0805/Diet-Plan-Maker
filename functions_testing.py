...
# Accessing index numbers of prefered items.
    ...
    br, ln, sn, dn = percentage(Final_calorie, nv_bcal, nv_bcate, nv_bname,nv_bserv, nv_lcal, nv_lcate, nv_lname, nv_scal, nv_scate, nv_sname, nv_dcal,nv_dcate, nv_dname)
    # print(br)
    # print(ln)
    return br,ln,sn,dn
...
def percentage(a,nv_bcal,nv_bcate, nv_bname,nv_bserv, nv_lcal, nv_lcate, nv_lname, nv_scal, nv_scate, nv_sname, nv_dcal, nv_dcate, nv_dname):
    Final_calorie = a
    nv_bcate = nv_bcate 
    nv_bname = nv_bname
    nv_bserv = nv_bserv
