...
def subsetSum(xyz, nv_bcal, a):
    ...
    return m 
        # for item in m:
            # k=collections.Counter(item)
            # if len(k)==2:
            #     print(k)
            # lmn = ['Palak Paratha', 'Honey Iced Tea', 'Papdi']
            # for elem in final_b_list[1:]:
            # k= collections.Counter(item) == collections.Counter(m)
            # #print(k)
            # if k != True:
            #     print(k)
...
def snacks_subsetSum():
    pass



# Creating final list for dinner
def dinner_subsetSum():
    pass
...
# a = [['a','b'], ['c']]
    ...
    # for item in final_b_list:
    #     for elem in final_b_list[0:]:
    #     # k= collections.Counter(item) == collections.Counter()
    #         if collections.Counter(item) == collections.Counter(elem):
    #             print(item)
    ...
    #         print(item)
        ...
        # if collections.Counter(item) in final_b_list:
        #     print(final_b_list)
